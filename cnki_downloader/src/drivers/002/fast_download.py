...
PAGE_TURN_DELAY = random.uniform(3, 5)  # 翻页后等待页面加载时间（秒）

# 页面一专属配置（根据新规则调整）
PAGE1_BASE_SPACING_OFFSET = 3  # 基础间距补偿（改为3像素）
PAGE1_BUTTON1_OFFSETS = [0, 2, -2, 4, -4]  # 按钮1偏移策略
