...
# 配置路径
EXCEL_PATH = r'D:\Desktop\合工大项目\A001_2509-2605全年重点项目环境规制\C004_政策索引\北大法宝\A001_环境规制\分类：效力位阶 - 副本\004部门规章(12976)\D4行政许可批复(1662)\【北大法宝】目录列表.xls'
INPUT_DIR = r'D:\Desktop\合工大项目\A001_2509-2605全年重点项目环境规制\C004_政策索引\北大法宝\A001_环境规制\分类：效力位阶 - 副本\004部门规章(12976)\D4行政许可批复(1662)\txt'
OUTPUT_DIR = r'D:\Desktop\合工大项目\A001_2509-2605全年重点项目环境规制\C004_政策索引\北大法宝\A001_环境规制\分类：效力位阶 - 副本\004部门规章(12976)\D4行政许可批复(1662)\output'
    ...
    if not matched_exact.empty:
        ...
        if not matched_truncated.empty:
            ...
            if matched_fuzzy is not None and max_ratio > 0.6:  # 调整相似度阈值为 0.6
                ...
                print(
                    f"✅ 模糊匹配成功：{filename} (相似度: {max_ratio:.2f}) -> 序号：{seq}, 制定机关：{agency}, 年份：{year}")
            else:
