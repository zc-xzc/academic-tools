...
INPUT_DIR = r'D:\Desktop\合工大项目\A001_2509-2605全年重点项目环境规制\C004_政策索引\北大法宝\A001_环境规制\分类：效力位阶 - 副本\004部门规章(12976)\D2部门规范性文件(3445)\doc'
OUTPUT_DIR = r'D:\Desktop\合工大项目\A001_2509-2605全年重点项目环境规制\C004_政策索引\北大法宝\A001_环境规制\分类：效力位阶 - 副本\004部门规章(12976)\D2部门规范性文件(3445)\output'
...
# 辅助函数：截取文件名的前20个字符（处理 Word 和 Txt 截断问题）
